...
func NewCmdWithOptions(cfg config.Context, options *ExecOptions) *cobra.Command {
...
func exec(cmd *cobra.Command, cfg config.Context, cmdArgs []string, unknownArgs []string, options *ExecOptions) error {
