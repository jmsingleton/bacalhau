...
func setupNodeForTest(t *testing.T) (*node.Node, config.Context) {
...
func setupNodeForTestWithConfig(t *testing.T, apiCfg publicapi.Config) (*node.Node, config.Context) {
