...
func SetDefaults(cfg BacalhauConfig, opts ...SetOption) {
	...
	p.Viper.SetDefault(NodeComputeDataPath, cfg.Node.Compute.DataPath)
	...
	p.Viper.SetDefault(NodeNetworkType, cfg.Node.Network.Type)
...
func Set(cfg BacalhauConfig, opts ...SetOption) {
	...
	p.Viper.Set(NodeComputeDataPath, cfg.Node.Compute.DataPath)
	...
	p.Viper.Set(NodeNetworkType, cfg.Node.Network.Type)
